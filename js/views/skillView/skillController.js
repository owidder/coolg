    ...
    function ($scope, $routeParams, $location, $timeout, $q, dimensions, funcs) {
        ...
        function createRadioButtonStyles() {
            ...
            skills.categories.forEach(function(category) {
                ...
                styleForUnchecked = "[type=\"radio\"].cat-" + cssNameOfStyle + ".with-gap:not(:checked) + label:before + {background-color: " + colorOfStyle + ";}\n";
                styleString += styleForChecked;
                styleString += styleForUnchecked;
            });
            styleString += "</style>\n";
            $("#radioStyles").append(styleString);
        }
        ...
        function drawVoronoiSkills(ya) {
            ...
            var vertices = filteredData.map(function (d) {
                ...
                vert.md = d[constants.ATTRIBUTE_MITTLERE_SKILLDAUER];
        ...
        function drawSkills(ya) {
            ...
            field.selectAll("circle.skill")
                ...
                .attr("_md", function (d) {
                    return d[constants.ATTRIBUTE_MITTLERE_SKILLDAUER];
                })
        ...
        skills.ready.then(function () {
            ...
            $scope.disableModeSwitch = disableModeSwitch;
            $scope.draw = draw;
